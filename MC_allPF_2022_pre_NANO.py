...
# with command line options: MC_allPF_2022_pre --mc --eventcontent NANOAODSIM --datatier NANOAODSIM --conditions auto:phase1_2022_realistic --step NANO --nThreads 4 --era Run3,run3_nanoAOD_pre142X --filein /store/mc/Run3Summer22MiniAODv4/QCD_PT-1000_MuEnrichedPt5_TuneCP5_13p6TeV_pythia8/MINIAODSIM/130X_mcRun3_2022_realistic_v5-v2/2520000/01a47259-4dba-40ba-9065-20fd20da2a6a.root -n 100 --customise PhysicsTools/NanoAOD/custom_btv_cff.BTVCustomNanoAOD_allPF --no_exec --customise_commands process.genWeightsTable.keepAllPSWeights=True
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/mc/Run3Summer22MiniAODv4/QCD_PT-1000_MuEnrichedPt5_TuneCP5_13p6TeV_pythia8/MINIAODSIM/130X_mcRun3_2022_realistic_v5-v2/2520000/01a47259-4dba-40ba-9065-20fd20da2a6a.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('MC_allPF_2022_pre nevts:100'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('MC_allPF_2022_pre_NANO.root'),
    # fileName = cms.untracked.string('/eos/user/c/cmunozdi/tmp/MC_allPF_2022_pre_NANO.root'),
