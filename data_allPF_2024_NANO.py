...
# with command line options: data_allPF_2024 --data --eventcontent NANOAOD --datatier NANOAOD --conditions 140X_dataRun3_v20 --step NANO --nThreads 4 --era Run3 --filein /store/data/Run2024C/Muon0/MINIAOD/MINIv6NANOv15-v1/2530000/00802afa-7a55-40cd-9f5a-846ad9e21a45.root -n 100 --customise PhysicsTools/NanoAOD/custom_btv_cff.BTVCustomNanoAOD_allPF --no_exec --customise_commands process.genWeightsTable.keepAllPSWeights=True
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2024C/Muon0/MINIAOD/MINIv6NANOv15-v1/2530000/00802afa-7a55-40cd-9f5a-846ad9e21a45.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('data_allPF_2024 nevts:100'),
