...
# with command line options: MC_allPF_2022_post --mc --eventcontent NANOAODSIM --datatier NANOAODSIM --conditions auto:phase1_2022_realistic_postEE --step NANO --nThreads 4 --era Run3,run3_nanoAOD_pre142X --filein /store/mc/Run3Summer22EEMiniAODv4/TTtoLNu2Q_TuneCP5_13p6TeV_powheg-pythia8/MINIAODSIM/130X_mcRun3_2022_realistic_postEE_v6-v2/2520000/00299132-00f2-4892-950a-4bcc268a63bc.root -n 100 --customise PhysicsTools/NanoAOD/custom_btv_cff.BTVCustomNanoAOD_allPF --no_exec --customise_commands process.genWeightsTable.keepAllPSWeights=True
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/mc/Run3Summer22EEMiniAODv4/TTtoLNu2Q_TuneCP5_13p6TeV_powheg-pythia8/MINIAODSIM/130X_mcRun3_2022_realistic_postEE_v6-v2/2520000/00299132-00f2-4892-950a-4bcc268a63bc.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('MC_allPF_2022_post nevts:100'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('MC_allPF_2022_post_NANO.root'),
